...
class Runner:
    ...
    def run(self):
        self.distance += 15  ####     изменение с 10 на 15
...
#   File "C:\Users\alexa\PycharmProjects\Module_12_Cycle_Support\Unit_Tests_1.py", line 38, in test_run
#     self.assertEqual(runner.distance, 100)
